...
<head>
    ...
    <!-- CSS com URLs das imagens processadas pelo Twig -->
    <style>
        .hero {
            background-image: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.5)), url('{{ "assets/corrente_elo_vazado.webp" | static_url }}');
        }
        
        @keyframes heroSlideshow {
            0%, 33.33% {
                background-image: url('{{ "assets/corrente_elo_vazado.webp" | static_url }}') !important;
            }
            33.34%, 66.66% {
                background-image: url('{{ "assets/fundo-banner.webp" | static_url }}') !important;
            }
            66.67%, 100% {
                background-image: url('{{ "assets/corrente_grumet.webp" | static_url }}') !important;
            }
        }
    </style>
